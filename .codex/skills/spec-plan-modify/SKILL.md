---
name: spec-plan-modify
description: Use when the user invokes `$spec-plan-modify` or asks to research and revise a named existing spec plan without implementing it.
---
...
> 方案已更新。若要開始實作，請執行 `$spec-plan-implement [提案簡稱]`。尚未執行 implement 前，請勿自行修改任何程式碼。
